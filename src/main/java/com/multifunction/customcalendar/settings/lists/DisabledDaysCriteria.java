package com.multifunction.customcalendar.settings.lists;
...
public class DisabledDaysCriteria {
    ...
    public DisabledDaysCriteria(DisabledDaysCriteriaType criteriaType, int... daysToDisable){
        setDays(criteriaType, daysToDisable);
    }
    ...
    public void setDays( DisabledDaysCriteriaType criteriaType, int... daysToDisable){
        int startRange = daysToDisable[0];
        int endRange = daysToDisable[daysToDisable.length-1];
