package com.multifunction.customcalendar.settings;

import android.support.v7.widget.LinearLayoutManager;

import com.multifunction.customcalendar.settings.appearance.AppearanceInterface;
import com.multifunction.customcalendar.settings.appearance.AppearanceModel;
import com.multifunction.customcalendar.settings.appearance.ConnectedDayIconPosition;
import com.multifunction.customcalendar.settings.date.DateInterface;
import com.multifunction.customcalendar.settings.date.DateModel;
import com.multifunction.customcalendar.settings.lists.CalendarListsInterface;
import com.multifunction.customcalendar.settings.lists.CalendarListsModel;
...
import com.multifunction.customcalendar.settings.selection.SelectionModel;
...
public class SettingsManager implements AppearanceInterface, DateInterface, CalendarListsInterface, SelectionInterface {
    ...
    public static final int DEFAULT_ORIENTATION = android.support.v7.widget.LinearLayoutManager.VERTICAL;
